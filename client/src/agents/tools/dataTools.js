/**
 * Data Collection & Processing Tools (browser-compatible)
 *
 * In-memory knowledge base for storing and retrieving research data.
 */

// In-memory knowledge base (resets each session)
const knowledgeBase = {
  entries: [],
  tags: new Map(),
};
...
/** Reset the knowledge base between research sessions */
export function resetKnowledgeBase() {
  knowledgeBase.entries = [];
  knowledgeBase.tags = new Map();
}
...
export const dataToolDeclarations = [
  {
    functionDeclarations: [
      ...
      {
        name: "storeData",
        description: "Store a piece of collected information in the knowledge base.",
        parameters: {
          type: "object",
          properties: {
            title: { type: "string", description: "Title for this data entry" },
      ...
      {
        name: "retrieveData",
        description: "Retrieve stored data from the knowledge base.",
        parameters: {
          type: "object",
          properties: {
      ...
      },
      {
        ...
        description: "Remove duplicate entries from the knowledge base.",
        parameters: { type: "object", properties: {} },
      },
      {
        name: "getDataStats",
        description: "Get statistics about the collected data.",
        parameters: { type: "object", properties: {} },
      },
    ],
  },
