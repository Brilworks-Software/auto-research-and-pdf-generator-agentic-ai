/**
 * Research Paper Tools (browser-compatible)
 *
...
export const researchToolDeclarations = [
  {
    functionDeclarations: [
      {
        name: "searchArxiv",
        description: "Search arXiv for research preprints.",
        parameters: {
          type: "object",
          properties: {
            query: { type: "string", description: "Search query" },
            maxResults: { type: "number", description: "Max papers (default 5)" },
          },
          required: ["query"],
        },
      },
      {
        ...
        description: "Search Semantic Scholar academic database.",
        parameters: {
          type: "object",
          properties: {
            query: { type: "string", description: "Search query" },
      ...
      },
      {
        ...
        parameters: {
          type: "object",
          properties: {
            paperId: { type: "string", description: "Paper ID, DOI:xxx, or ARXIV:xxx" },
          },
          required: ["paperId"],
        },
      },
      {
        name: "resolveDOI",
        description: "Resolve a DOI to get paper metadata from CrossRef.",
        parameters: {
          type: "object",
          properties: {
            doi: { type: "string", description: "The DOI to resolve" },
          },
          required: ["doi"],
        },
      },
