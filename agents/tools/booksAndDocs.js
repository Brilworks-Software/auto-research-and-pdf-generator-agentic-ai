 ...
 *  • Documentation sites — MDN, DevDocs, ReadTheDocs, etc.
 */
...
/**
 * Search Google Books for books on a topic.
 */
...
/**
 * Search Open Library for books (free, open-source book database).
 */
...
/**
 * Get detailed info about a specific book from Open Library by its key.
 */
...
// ═══════════════════════════════════════════════════════════════════════════════
//  DOCUMENTATION SEARCH (generic — fetches & extracts from any doc site)
// ═══════════════════════════════════════════════════════════════════════════════

/**
 * Search for documentation/tutorials using DuckDuckGo site-specific queries.
 * Targets known documentation sites.
 */
