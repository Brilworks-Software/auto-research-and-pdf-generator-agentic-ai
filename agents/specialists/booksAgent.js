/**
 * Books & Documentation Agent (Code-Driven)
 *
 * Searches Google Books, Open Library, and documentation sites
 * to find relevant books, textbooks, and technical documentation.
 */
...
export class BooksAgent {
  ...
  async run(task) {
    ...
    // Step 4: Get detailed info for top 2 Open Library books
    ...
    // Step 5: Search documentation sites
    for (const q of queries.slice(0, 2)) {
      try {
